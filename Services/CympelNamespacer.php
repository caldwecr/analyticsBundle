    ...
    public function addEntityToCympelNamespace(iNamespaceable $entity, iNamespace $cympelNamespace)
    {
        ...
        if(!$ens || $cympelNamespace->equals($ens) || $ens->equals(CympelNamespace::getBlankCympelNamespace())) {
            ...
            if(!$ens) {
                ...
                throw new InvalidAttemptToSetEntityCympelNamespace('This entity already has a namespace associated with it, to change the namespace first remove the existing one. ENS = ' . $ens->getName() . ' cn=' . $cympelNamespace->getName());
            }
        }
